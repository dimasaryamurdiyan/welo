...
<nav class="navbar navbar-default navbar-fixed-top" role ="navigation">
    ...
    <div class="sidenav">
          <a class="menu" href="/dashboard">
                <img class="chart-menu" src="/dash.png" height="50" width="50">&#160 &#160 &#160 Dashboard
          </a>
          <button class="dropdown-btn">
                <img class="chart-menu" src="/order.png" height="50" width="50">&#160 &#160 &#160 Pesanan Laundry &#160
          ...
          <button class="dropdown-btn">
                <img class="chart-menu" src="/packet.png" height="50" width="50">&#160 &#160 &#160 Paket Laundry &#160
                <i class="fa fa-caret-down"></i>
          </button>
          <div class="dropdown-container">
          ...
          <a class="menu" href="/customer">
            <img class="chart-menu" src="/customer.png" height="50" width="50">&#160 &#160 &#160 Customer
          </a>
          <a class="menu" href="/">
            <img class="chart-menu" src="/logout.png" height="50" width="50">&#160 &#160 &#160 Logout
          </a>
    </div>
</body>
